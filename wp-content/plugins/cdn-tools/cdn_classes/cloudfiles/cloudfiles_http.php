...
class CF_Http
{
    ...
    private function _send_request($conn_type, $url_path, $hdrs=NULL, $method="GET")
    {
		...
		//THIS IS THE BIG NASTY PUT_OBJ BUG. ASSUMES RETURN_TRANSFER WILL RETURN SOMETHING. BUT PUTTING OBJECTS DOESN'T DO THAT. CHECK THAT ERROR IS ZERO AND MOVE ON FOR NOW
